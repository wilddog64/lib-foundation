...
- [ ] **v0.3.6: indented fence fix** — Codex assigned; fix `_dh_strip_fences` to match indented fences + 1 BATS test; spec `docs/plans/v0.3.6-doc-hygiene-indented-fence-fix.md`; PR #12 open.
