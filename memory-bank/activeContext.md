...
**fix/copilot-deny-tool-patterns ACTIVE** — combined `--allow-all-tools` + deny-tool fix; ASSIGNED TO CODEX. Spec: `docs/bugs/2026-05-02-copilot-review-noninteractive-combined-fix.md`.
