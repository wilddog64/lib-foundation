...
- [ ] **Indented fence fix** — Codex assigned; fix `_dh_strip_fences` for indented fenced blocks + 1 BATS test; spec `docs/plans/v0.3.6-doc-hygiene-indented-fence-fix.md`.
